  ...
  return (
    <div className="bg-gray-50 min-h-screen p-8" style={{ fontFamily: "Albert Sans" }}>
      ...
      <div className="flex items-start justify-between mb-8 gap-4 flex-wrap">
        <div>
          <h1 className="text-4xl font-bold text-gray-900">Illoura Reports</h1>
          <p className="text-gray-500 mt-1">Sales performance for Illoura staff orders.</p>
        </div>
        <Button
          variant="outline"
          onClick={() => refetch()}
