...
// Illoura Staff admin navigation
const allNavigation = [
  { name: "Orders", href: "/admin/ellora/orders" },
  { name: "Products", href: "/admin/ellora/products" },
  { name: "Categories", href: "/admin/ellora/categories" },
  { name: "Options", href: "/admin/ellora/options" },
  { name: "Dietary Codes", href: "/admin/ellora/dietary-codes" },
        ...
        <div className="flex flex-row justify-end items-center gap-2 sm:gap-3 flex-shrink-0">
          ...
          {/* <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                <Bell className="w-5 h-5 text-[#212529] transition-colors duration-200 group-hover:text-[#243F2A]" />
            ...
            >
                ...
                <div className="flex items-center justify-between">
                  ...
                  {unreadCount > 0 && (
                    <button
                      ...
                      className="text-xs text-[#243F2A] hover:underline font-medium disabled:opacity-50"
                    >
                      Mark all as read
                    </button>
                  )}
                  ...
                  notifications.map((notification: any) => (
                    <DropdownMenuItem
                      ...
                      className={cn(
                        ...
                        !notification.read_status && "bg-[#EAF0EC]/50"
                      )}
                    >
              ...
              <div className="px-4 py-3 border-t border-gray-200">
                <Link
                  href="/notifications"
                  className="text-sm text-[#243F2A] hover:underline font-medium text-center block"
                >
